...
int main()
{
    ...
    // int numPoints = readPointsFromFile("Data/datapoint.txt", points, MAX_POINTS);
    int numPoints = readPointsFromFile("Data/gaussian_data_points_100k.csv", points, MAX_POINTS);
    // int numPoints = readPointsFromFile("Data/gaussian_data_points_1M.csv", points, MAX_POINTS);
    if (numPoints <= 0)
    {
